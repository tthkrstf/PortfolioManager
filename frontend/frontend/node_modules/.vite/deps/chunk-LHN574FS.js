  ...
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      function useSyncExternalStore$2(subscribe, getSnapshot) {
        didWarnOld18Alpha || void 0 === React57.startTransition || (didWarnOld18Alpha = true, console.error(
      ...
      var React57 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is2, useState7 = React57.useState, useEffect16 = React57.useEffect, useLayoutEffect = React57.useLayoutEffect, useDebugValue = React57.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React57 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is2, useSyncExternalStore = shim.useSyncExternalStore, useRef12 = React57.useRef, useEffect16 = React57.useEffect, useMemo9 = React57.useMemo, useDebugValue = React57.useDebugValue;
...
function scaleSymlog(_domain, _range) {
  ...
  scale2.ticks = (count2) => {
    ...
    const constant2 = scale2.constant();
  ...
  scale2.tickFormat = (count2 = 10, specifier) => {
    const constant2 = scale2.constant();
    const [start2, end2] = scale2.domain();
...
var selectorChartZoomAxisFilters = createSelector2([selectorChartXFilter, selectorChartYFilter, selectorChartRawXAxis, selectorChartRawYAxis], (xMapper, yMapper, xAxis, yAxis) => {
  ...
  const xFilters = xAxis?.reduce((acc, axis, index2) => {
  ...
  const yFilters = yAxis?.reduce((acc, axis, index2) => {
...
var useChartPolarAxis = ({
  ...
  const svg2rotation = React7.useMemo(() => generateSvg2rotation({
    cx: center.cx,
    cy: center.cy
  }), [center.cx, center.cy]);
  const svg2polar = React7.useMemo(() => generateSvg2polar({
    cx: center.cx,
    cy: center.cy
  }), [center.cx, center.cy]);
  const polar2svg = React7.useMemo(() => generatePolar2svg({
    cx: center.cx,
    cy: center.cy
  }), [center.cx, center.cy]);
...
var useChartAnimation = ({
  ...
  const disableAnimation = React8.useCallback(() => {
...
var useChartInteractionListener = ({
  ...
  const addInteractionListener = React10.useCallback((interaction, callback, options) => {
    const svg = svgRef.current;
...
function useCharts(inPlugins, props, seriesConfig5) {
  const chartId = useId();
  const plugins = React11.useMemo(() => [...CHART_CORE_PLUGINS, ...inPlugins], [inPlugins]);
  const pluginParams = extractPluginParamsFromProps({
    plugins,
    props
  });
  pluginParams.id = pluginParams.id ?? chartId;
  const instanceRef = React11.useRef({});
  const instance = instanceRef.current;
  const publicAPI = useChartApiInitialization(props.apiRef);
  const innerChartRootRef = React11.useRef(null);
  const innerSvgRef = React11.useRef(null);
...
function useChartApiInitialization(inputApiRef) {
  const fallbackPublicApiRef = React11.useRef({});
  if (inputApiRef) {
...
function useLazySelectorEffect(store, selector, effect4, skip) {
  ...
  React14.useEffect(instance.onMount(skip), [skip]);
}
...
var selectorChartsHighlightXAxisIndex = createSelector2([selectorChartsInteractionXAxisIndex, selectorChartXAxis, selectorChartControlledCartesianAxisHighlight], selectAxisHighlight);
var selectorChartsHighlightYAxisIndex = createSelector2([selectorChartsInteractionYAxisIndex, selectorChartYAxis, selectorChartControlledCartesianAxisHighlight], selectAxisHighlight);
...
var selectorChartsHighlightXAxisValue = createSelector2([selectorChartsInteractionXAxisIndex, selectorChartsInteractionXAxisValue, selectorChartXAxis, selectorChartControlledCartesianAxisHighlight], selectAxisHighlightWithValue);
var selectorChartsHighlightYAxisValue = createSelector2([selectorChartsInteractionYAxisIndex, selectorChartsInteractionYAxisValue, selectorChartYAxis, selectorChartControlledCartesianAxisHighlight], selectAxisHighlightWithValue);
...
var selectorChartPreviewComputedYAxis = createSelector2([selectorChartRawYAxis, selectorChartSeriesProcessed, selectorChartSeriesConfig, selectorChartZoomOptionsLookup, selectorChartZoomAxisFilters, selectorChartDrawingArea, (_, axisId) => axisId], (yAxes, formattedSeries, seriesConfig5, zoomOptions, getFilters, chartDrawingArea, axisId) => {
...
function ChartProvider(props) {
  ...
  return (0, import_jsx_runtime5.jsx)(ChartContext.Provider, {
    value: contextValue,
    children
  });
}
...
var selectorChartsHighlightedItem = createSelector2([selectHighlight], function selectorChartsHighlightedItem2(highlight) {
...
function useChartGradientIdBuilder() {
  ...
  return React20.useCallback((axisId) => `${chartId}-gradient-${axisId}`, [chartId]);
}
function useChartGradientIdObjectBoundBuilder() {
  const chartId = useChartId2();
  return React20.useCallback((axisId) => `${chartId}-gradient-${axisId}-object-bound`, [chartId]);
}
...
var consumeThemeProps = (name, options, InComponent) => React24.forwardRef(function ConsumeThemeInternal(props, ref) {
  ...
  return (0, import_jsx_runtime8.jsx)(OutComponent, _extends({}, outProps, {
    classes,
    ref
  }));
});
...
var ChartsLabelMark = consumeThemeProps("MuiChartsLabelMark", {
  ...
  return (0, import_jsx_runtime9.jsx)(Root, _extends({
    ...
    children: (0, import_jsx_runtime9.jsx)("div", {
      ...
      children: typeof Component === "function" ? (0, import_jsx_runtime9.jsx)(Component, {
        className: classes?.fill,
        color: color2
      }) : (0, import_jsx_runtime9.jsx)("svg", {
        viewBox: "0 0 24 24",
        preserveAspectRatio: type === "line" ? "none" : void 0,
        children: type === "circle" ? (0, import_jsx_runtime9.jsx)("circle", {
          className: classes?.fill,
          r: "12",
          cx: "12",
          cy: "12",
          fill: color2
        }) : (0, import_jsx_runtime9.jsx)("rect", {
          className: classes?.fill,
          width: "24",
          height: "24",
          fill: color2
...
true ? ChartsLabelMark.propTypes = {
   ...
   * @default 'square'
   */
  type: import_prop_types4.default.oneOf(["circle", "line", "square"])
} : void 0;
...
function ChartsItemTooltipContent(props) {
  ...
  const classes = useUtilityClasses2(propClasses);
  if (!tooltipData) {
    return null;
  }
  if ("values" in tooltipData) {
    ...
    return (0, import_jsx_runtime10.jsx)(ChartsTooltipPaper, {
      ...
      children: (0, import_jsx_runtime10.jsxs)(ChartsTooltipTable, {
        ...
        children: [(0, import_jsx_runtime10.jsxs)(Typography_default, {
          component: "caption",
          ...
          children: tooltipData.values.map(({
            ...
            label: label2
          }) => (0, import_jsx_runtime10.jsxs)(ChartsTooltipRow, {
  ...
  return (0, import_jsx_runtime10.jsx)(ChartsTooltipPaper, {
    sx,
    className: classes.paper,
    children: (0, import_jsx_runtime10.jsx)(ChartsTooltipTable, {
      className: classes.table,
      children: (0, import_jsx_runtime10.jsx)("tbody", {
        children: (0, import_jsx_runtime10.jsxs)(ChartsTooltipRow, {
          className: classes.row,
...
function usePointerType() {
  ...
  const [pointerType, setPointerType] = React28.useState(null);
  React28.useEffect(() => {
    const element = svgRef.current;
    if (element === null) {
      return () => {
...
function ChartsAxisTooltipContent(props) {
  ...
  return (0, import_jsx_runtime11.jsx)(ChartsTooltipPaper, {
    ...
    children: tooltipData.map(({
      ...
      return (0, import_jsx_runtime11.jsxs)(ChartsTooltipTable, {
        className: classes.table,
        children: [axisValue != null && !mainAxis.hideTooltip && (0, import_jsx_runtime11.jsx)(Typography_default, {
          component: "caption",
          ...
          children: seriesItems.map(({
            ...
            return (0, import_jsx_runtime11.jsxs)(ChartsTooltipRow, {
              className: classes.row,
              children: [(0, import_jsx_runtime11.jsxs)(ChartsTooltipCell, {
                className: clsx_default(classes.labelCell, classes.cell),
                component: "th",
...
function getReactElementRef(element) {
  if (parseInt(React30.version, 10) >= 19) {
...
var PopperTooltip = React32.forwardRef(function PopperTooltip2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime12.jsx)(Root4, {
    ...rootProps,
...
function ChartsTooltipContainer(inProps) {
  ...
  const anchorEl = React35.useMemo(() => ({
  ...
  return (0, import_jsx_runtime14.jsx)(NoSsr_default, {
    children: isOpen && (0, import_jsx_runtime14.jsx)(ChartsTooltipRoot, _extends({
      className: classes?.root,
      open: isOpen,
...
true ? ChartsTooltipContainer.propTypes = {
   ...
   * so it's simply `document.body` most of the time.
   */
  container: import_prop_types11.default.oneOfType([(props, propName) => {
   ...
   * A ref that points to the used popper instance.
   */
  popperRef: import_prop_types11.default.oneOfType([import_prop_types11.default.func, import_prop_types11.default.shape({
    current: import_prop_types11.default.shape({
      destroy: import_prop_types11.default.func.isRequired,
      forceUpdate: import_prop_types11.default.func.isRequired,
      setOptions: import_prop_types11.default.func.isRequired,
      state: import_prop_types11.default.shape({
        attributes: import_prop_types11.default.object.isRequired,
        elements: import_prop_types11.default.object.isRequired,
        modifiersData: import_prop_types11.default.object.isRequired,
        options: import_prop_types11.default.object.isRequired,
        orderedModifiers: import_prop_types11.default.arrayOf(import_prop_types11.default.object).isRequired,
        placement: import_prop_types11.default.oneOf(["auto-end", "auto-start", "auto", "bottom-end", "bottom-start", "bottom", "left-end", "left-start", "left", "right-end", "right-start", "right", "top-end", "top-start", "top"]).isRequired,
        rects: import_prop_types11.default.object.isRequired,
        reset: import_prop_types11.default.bool.isRequired,
        scrollParents: import_prop_types11.default.object.isRequired,
        strategy: import_prop_types11.default.oneOf(["absolute", "fixed"]).isRequired,
        styles: import_prop_types11.default.object.isRequired
      }).isRequired,
      update: import_prop_types11.default.func.isRequired
    })
  })]),
  /**
   * The props used for each slot inside the Popper.
...
function ChartsTooltip(props) {
  ...
  const classes = useUtilityClasses2(propClasses);
  return (0, import_jsx_runtime15.jsx)(ChartsTooltipContainer, _extends({}, props, {
    classes: propClasses,
    children: trigger === "axis" ? (0, import_jsx_runtime15.jsx)(ChartsAxisTooltipContent, {
      classes
    }) : (0, import_jsx_runtime15.jsx)(ChartsItemTooltipContent, {
      classes
    })
  }));
}
...
var consumeSlots = (name, slotPropName, options, InComponent) => {
  function ConsumeSlotsInternal(props, ref) {
    ...
    return (0, import_jsx_runtime16.jsx)(Component, _extends({}, outProps, {
      ref
    }));
  }
  return React37.forwardRef(ConsumeSlotsInternal);
};
...
var ChartsLabel = consumeThemeProps("MuiChartsLabel", {
  ...
  return (0, import_jsx_runtime17.jsx)("span", _extends({
    className: clsx_default(classes?.root, className),
    ref
  }, other, {
    children
...
var ChartsLegend = consumeSlots("MuiChartsLegend", "legend", {
...
}, React39.forwardRef(function ChartsLegend2(props, ref) {
  ...
  return (0, import_jsx_runtime18.jsx)(RootElement, _extends({
    className: clsx_default(classes?.root, className),
    ref
  }, other, {
    ownerState: props,
    children: data.items.map((item, i) => {
      return (0, import_jsx_runtime18.jsx)("li", {
        ...
        "data-series": item.id,
        children: (0, import_jsx_runtime18.jsxs)(Element2, {
          ...
          children: [(0, import_jsx_runtime18.jsx)(ChartsLabelMark, {
            className: classes?.mark,
            color: item.color,
            type: item.markType
          }), (0, import_jsx_runtime18.jsx)(ChartsLabel, {
...
var ChartsLabelGradient = consumeThemeProps("MuiChartsLabelGradient", {
  ...
  const isRtl = useRtl();
  return (0, import_jsx_runtime19.jsx)(Root2, _extends({
    className: clsx_default(classes?.root, className),
    ...
    children: (0, import_jsx_runtime19.jsx)("div", {
      className: classes?.mask,
      children: (0, import_jsx_runtime19.jsx)("svg", {
        viewBox: "0 0 24 24",
...
true ? ChartsLabelGradient.propTypes = {
   ...
   * @default 'horizontal'
   */
  direction: import_prop_types15.default.oneOf(["vertical", "horizontal"]),
  /**
   * A unique identifier for the gradient.
   * The `gradientId` will be used as `fill="url(#gradientId)"`.
   */
  gradientId: import_prop_types15.default.string.isRequired,
  /**
   ...
   */
  rotate: import_prop_types15.default.bool,
  /**
...
var ContinuousColorLegend = consumeThemeProps("MuiContinuousColorLegend", {
  ...
  const minComponent = (0, import_jsx_runtime20.jsx)("li", {
    className: classes?.minLabel,
    children: (0, import_jsx_runtime20.jsx)(ChartsLabel, {
      className: classes?.label,
      children: minText
    })
  });
  const maxComponent = (0, import_jsx_runtime20.jsx)("li", {
  ...
  return (0, import_jsx_runtime20.jsxs)(RootElement2, _extends({
    className: clsx_default(classes?.root, className),
    ref
  }, other, {
    ownerState: props,
    children: [reverse2 ? maxComponent : minComponent, (0, import_jsx_runtime20.jsx)("li", {
      className: classes?.gradient,
      children: (0, import_jsx_runtime20.jsx)(ChartsLabelGradient, {
        direction,
...
true ? ContinuousColorLegend.propTypes = {
   ...
   */
  gradientId: import_prop_types16.default.string,
  /**
   * Where to position the labels relative to the gradient.
   * @default 'end'
   */
  labelPosition: import_prop_types16.default.oneOf(["start", "end", "extremes"]),
  /**
   ...
   * Useful for linear gradients that are not in the correct orientation.
   */
  rotateGradient: import_prop_types16.default.bool,
  /**
   * The thickness of the gradient
   * @default 12
   */
...
var PiecewiseColorLegend = consumeThemeProps("MuiPiecewiseColorLegend", {
  ...
  return (0, import_jsx_runtime21.jsx)(RootElement3, _extends({
    className: clsx_default(classes?.root, className),
    ref
  }, other, {
    ownerState: props,
    children: orderedColors.map(({
      ...
      return (0, import_jsx_runtime21.jsx)("li", {
        children: (0, import_jsx_runtime21.jsxs)(Element2, {
          role: onItemClick ? "button" : void 0,
          type: onItemClick ? "button" : void 0,
          onClick: (
            // @ts-ignore onClick is only attached to a button
          ...
          children: [isTextBefore && (0, import_jsx_runtime21.jsx)(ChartsLabel, {
            className: classes?.label,
            children: label
          }), (0, import_jsx_runtime21.jsx)(ChartsLabelMark, {
            className: classes?.mark,
            type: markType,
            color: color2
          }), isTextAfter && (0, import_jsx_runtime21.jsx)(ChartsLabel, {
            className: classes?.label,
            children: label
          })]
        })
...
true ? PiecewiseColorLegend.propTypes = {
   ...
   * @default 'square'
   */
  markType: import_prop_types17.default.oneOf(["square", "circle", "line"]),
  /**
   * Callback fired when a legend item is clicked.
   * @param {React.MouseEvent<HTMLButtonElement, MouseEvent>} event The click event.
...
var useInteractionItemProps = (data, skip) => {
  ...
  const interactionActive = React43.useRef(false);
  const onPointerEnter = React43.useCallback(() => {
  ...
  const onPointerLeave = React43.useCallback(() => {
...
function ChartsOverlay(props) {
  ...
  if (props.loading) {
    ...
    return (0, import_jsx_runtime24.jsx)(LoadingOverlay, _extends({}, props.slotProps?.loadingOverlay));
  }
  if (noData) {
    const NoDataOverlay = props.slots?.noDataOverlay ?? ChartsNoDataOverlay;
    return (0, import_jsx_runtime24.jsx)(NoDataOverlay, _extends({}, props.slotProps?.noDataOverlay));
  }
  return null;
}
  ...
  return (0, import_jsx_runtime25.jsx)("linearGradient", {
    ...
    children: colorMap.thresholds.map((threshold2, index2) => {
      ...
      return (0, import_jsx_runtime25.jsxs)(React47.Fragment, {
        children: [(0, import_jsx_runtime25.jsx)("stop", {
          offset: offset2,
          stopColor: colorMap.colors[index2],
          stopOpacity: 1
        }), (0, import_jsx_runtime25.jsx)("stop", {
          offset: offset2,
...
function ChartsContinuousGradientObjectBound(props) {
  ...
  const keyPrefix = `${extremumValues[0]}-${extremumValues[1]}-`;
  return (0, import_jsx_runtime27.jsx)("linearGradient", _extends({
    id: gradientId
    ...
    children: Array.from({
      ...
      return (0, import_jsx_runtime27.jsx)("stop", {
        offset: offset2,
        stopColor: color2,
        stopOpacity: 1
      }, keyPrefix + index2);
  ...
  return (0, import_jsx_runtime28.jsxs)("defs", {
    children: [filteredYAxisIds.map((axisId) => {
      ...
      if (colorMap?.type === "piecewise") {
        return (0, import_jsx_runtime28.jsx)(ChartsPiecewiseGradient, {
          isReversed: !reverse2,
          scale: scale2,
          colorMap,
          size: svgHeight,
      ...
      if (colorMap?.type === "continuous") {
        return (0, import_jsx_runtime28.jsxs)(React50.Fragment, {
          children: [(0, import_jsx_runtime28.jsx)(ChartsContinuousGradient, {
            ...
            gradientId,
            direction: "y"
          }), (0, import_jsx_runtime28.jsx)(ChartsContinuousGradientObjectBound, {
            isReversed: reverse2,
            colorScale,
            colorMap,
      ...
      if (colorMap?.type === "continuous") {
        return (0, import_jsx_runtime28.jsx)(ChartsContinuousGradientObjectBound, {
          colorScale,
          colorMap,
          gradientId: objectBoundGradientId
...
var ChartsSurface = React51.forwardRef(function ChartsSurface2(inProps, ref) {
  const store = useStore();
  const {
    width: svgWidth,
    height: svgHeight
  ...
  return (0, import_jsx_runtime29.jsxs)(ChartsSurfaceStyles, _extends({
    ownerState: {
      width: propsWidth,
      height: propsHeight
    },
    ...
    ref: handleRef,
    children: [title && (0, import_jsx_runtime29.jsx)("title", {
      children: title
    }), desc && (0, import_jsx_runtime29.jsx)("desc", {
      children: desc
    }), (0, import_jsx_runtime29.jsx)(ChartsAxesGradients, {}), hasIntrinsicSize && children]
  }));
});
...
var ChartsSlotsContext = React53.createContext(null);
...
var selectorChartsVoronoiIsVoronoiEnabled = createSelector2([selectVoronoi], (voronoi) => voronoi?.isVoronoiEnabled);
...
function ChartDataProvider(props) {
  ...
  return (0, import_jsx_runtime32.jsx)(ChartProvider, _extends({}, chartProviderProps, {
...
function ChartsWrapper(props) {
  ...
  return (0, import_jsx_runtime33.jsx)(Root3, {
    ref: chartRootRef,
    ownerState: props,
    sx,
...
true ? ChartsWrapper.propTypes = {
   ...
   */
  extendVertically: import_prop_types21.default.bool,
  /**
   * The direction of the legend.
   * @default 'horizontal'
   */
  legendDirection: import_prop_types21.default.oneOf(["horizontal", "vertical"]),
  /**
   * The position of the legend.
   * @default { horizontal: 'center', vertical: 'bottom' }
   */
  legendPosition: import_prop_types21.default.shape({
    horizontal: import_prop_types21.default.oneOf(["center", "end", "start"]),
    vertical: import_prop_types21.default.oneOf(["bottom", "middle", "top"])
  }),
...
use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-LHN574FS.js.map
